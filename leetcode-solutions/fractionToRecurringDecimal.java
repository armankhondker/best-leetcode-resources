...
//TC: O(denomination)
//SC: O(length(divisor aka denominator) for the hashmap
public class Solution {
    public String fractionToDecimal(int numerator, int denominator) {
        ...
        // "+" or "-"
        res.append(((numerator > 0) ^ (denominator > 0)) ? "-" : "");  // make this logic clener

        //to handle overflow can make these be longs 
